...
export default class TestCafeRunnerView {
    constructor(serializedState, closeIt) {
        ...
        this.element.classList.add('testcafe-runner-atom-plugin-view');

        this.console = document.createElement('div');
        this.console.classList.add('testcafe-runner-atom-plugin-view-terminal');

        this.closing = document.createElement('div');
        this.closing.classList.add('testcafe-runner-atom-plugin-view-close-button');
