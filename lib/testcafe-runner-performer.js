...
import {
    terminalMessages
} from './testcafe-runner-atom-plugin-notifications';
...
import {
    base
} from './testcafe-runner-atom-plugin-theme';
...
export default class Performer {
    ...
    prepare() {
        this.terminal.open(document.querySelector('.testcafe-runner-atom-plugin-view-terminal'));
